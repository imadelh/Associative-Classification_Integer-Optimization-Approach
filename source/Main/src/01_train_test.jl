...
#age = by(df,:Age,nrow)
#Annee = by(df,:Annee,nrow)
#Nod = by(df, :Nodules, nrow)
#writetable("../res/dispersion_age.txt",age)
#writetable("../res/dispersion_Annee.txt",Annee)
#writetable("../res/dispersion_Nod.txt",Nod)
